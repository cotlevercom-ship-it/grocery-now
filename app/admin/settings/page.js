...
const KEYS = ['contact_email', 'whatsapp_number', 'facebook_url', 'listing_price_monthly_regular', 'listing_price_monthly', 'listing_price_yearly_regular', 'listing_price_yearly', 'cofounder_price_yearly', 'bkash_payment_number']
...
const FIELD_META = {
  ...
  listing_price_monthly_regular: { label: 'Listing Price — Monthly, Regular (৳)', placeholder: '500' },
  listing_price_monthly: { label: 'Listing Price — Monthly, Discount (৳, actually charged)', placeholder: '350' },
  listing_price_yearly_regular: { label: 'Listing Price — Yearly, Regular (৳)', placeholder: '6000' },
  listing_price_yearly: { label: 'Listing Price — Yearly, Discount (৳, actually charged)', placeholder: '2500' },
