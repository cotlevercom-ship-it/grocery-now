              ...
              <div key={type} style={{ marginBottom: '22px' }}>
                ...
                {type === 'investor' && (
                  <div style={{
                    ...
                    Return type, ROI, and duration shown here are the business owner's stated intent, not a guarantee. Cotlever does not hold funds or enforce these terms — investors and business owners should formalize the agreed terms in a written agreement before transferring money.
                  </div>
                )}
              </div>
            )
