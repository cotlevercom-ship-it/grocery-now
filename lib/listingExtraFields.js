...
export const EXTRA_FIELD_CONFIG = {
  ...
  investor: {
    ...
    fields: [
      ...
      { key: 'return_type', label: 'Return type offered', type: 'select', options: ['Equity', 'Profit Sharing', 'Fixed Return', 'Convertible Note'] },
      { key: 'roi_details', label: 'ROI details', type: 'textarea', placeholder: 'e.g. 25% profit share over 5 years, or 15% equity with buyback option at exit' },
