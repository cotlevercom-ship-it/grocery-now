...
export const EXTRA_FIELD_CONFIG = {
  ...
  share_holder: {
    label: 'Share holder details',
    fields: [
      { key: 'equity_percent', label: 'Equity % on offer', type: 'text', placeholder: 'e.g. 5-15%' },
      { key: 'investment_needed', label: 'Investment amount sought', type: 'text', placeholder: 'e.g. ৳5,00,000' },
      { key: 'use_of_funds', label: 'What will the investment be used for?', type: 'textarea' },
      { key: 'stage', label: 'Current stage', type: 'select', options: ['Idea', 'MVP', 'Launched', 'Revenue-generating'] },
    ],
  },
}
